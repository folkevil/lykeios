                    ...
                    <div class="bg-white shadow">
                        ...
                        <form class="p-8">
                            ...
                            <div class="mb-8">
                                ...
                                <input type="password" name="password" class="px-4 py-3 border-2 rounded w-full text-grey-darkest">
                            </div>

                            <button type="submit"
                                    class="px-8 py-3 rounded text-white block mx-auto border-2 border-transparent bg-teal hover:border-teal hover:bg-transparent hover:text-teal">
                                Login
                            </button>
                        </form>
                    </div>
