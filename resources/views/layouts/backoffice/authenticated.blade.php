...
<html lang="{{ app()->getLocale() }}">
    ...
    <body class="font-sans antialiased bg-grey-lighter">
        <div id="app" class="lg:flex lg:flex-row">
                    ...
                    <div class="hidden lg:flex lg:justify-center">
                        <div class="relative">
                            ...
                            <div class="absolute pin-b pin-r">
                                <a href="#" id="user-settings" role="button" class="inline-flex items-center px-1 py-1 rounded text-grey-dark text-xs rounded-full bg-white border hover:bg-grey-light">
                                ...
                                <div id="user-settings-menu" class="hidden text-left bg-white shadow-md absolute pin-l rounded w-32 z-10">
                                    <span class="px-4 py-4 text-grey-darker text-2xs uppercase font-bold">{{ auth()->user()->name }}</span>
                                    <a href="" class="px-4 py-2 text-grey-dark text-xs hover:bg-grey-lighter">My Account</a>
                                    <a href="{{ route('logout') }}"
                                       class="px-4 py-2 text-grey-dark text-xs hover:bg-grey-lighter"
            ...
            <main class="p-4 lg:px-20 lg:py-6 lg:w-4/5">
                @yield('content')
            </main>
        </div>
